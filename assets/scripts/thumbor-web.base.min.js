...
if($.isFunction(o.onLeave)){o.onLeave(element,position);}}}});});}})})(jQuery,window,document,undefined);(function($){var lastSize=0;var interval=null;$.fn.resetBreakpoints=function(){$(window).unbind('resize');if(interval){clearInterval(interval);}
...
if(lastSize!=w){lastSize=w;}},250);};})(jQuery);/*! iScroll v5.1.3 ~ (c) 2008-2014 Matteo Spinelli ~ http://cubiq.org/license */
